...
<html lang="es">
    <head>
        <title>Administración - Jeloviar Academy</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="description" content= "Empresa de multinivel de productos de primera necesidad" />
        <meta name="robots" content= "index, follow">
        <meta name="keywords" content="icm, icm libertad, empresa multinivel, mlm, primera necesidad, ventas de productos, evolucion web, software multinivel"/>
        <meta name="author" content="Rolando Contreras Huidobro" />
