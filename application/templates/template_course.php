...
<html lang="en-US" class="no-js stm_lms_type_video">
    <head>
        ...
        <title>Jeloviar Online | Plataforma de Curso</title>
        <link rel='stylesheet' href='<?php echo site_url() . 'assets/course/css/mystyle.css?ver=29'; ?>' type='text/css' media='all' />
        ...
        <link rel='stylesheet' id='stm-lms-lesson_video-css' href='<?php echo site_url() . 'assets/course/css/lesson_video.css?ver=29'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' href='<?php echo site_url() . 'assets/backoffice/css/bootstrap.min.css?ver=3.2'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' id='theme-style-less-css' href='<?php echo site_url() . 'assets/course/css/styles.css?ver=3.2'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' id='redux-google-fonts-stm_option-css' href='https://fonts.googleapis.com/css?family=Montserrat%3A200%2C300%2C500%2C600%2C400%2C700%7COpen+Sans%3A300%2C400%2C600%2C700%2C800%2C300italic%2C400italic%2C600italic%2C700italic%2C800italic&#038;subset=latin&#038;ver=1589966475' type='text/css' media='all' />
        <!-- favicon-->
    ...
    <body class="logged-in stm_lms_button skin_custom_color classic_lms stm_preloader_1 wpb-js-composer js-comp-ver-5.6 vc_responsive">
        ...
        <link rel='stylesheet' id='stm-lms-lesson-css' href='<?php echo site_url() . 'assets/course/css/lesson.css?ver=29'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' id='stm-lms-curriculum-css' href='<?php echo site_url() . 'assets/course/css/curriculum.css?ver=29'; ?>' type='text/css' media='all' />
        <script src='<?php echo site_url() . 'assets/course/js/bootstrap.min.js?ver=3.2'; ?>'></script>
        ...
        <script src='<?php echo site_url() . 'assets/course/js/curriculum_trigger.js?ver=29'; ?>'></script>
        <script src='<?php echo site_url() . 'assets/course/js/lesson_sidebar.js?ver=29'; ?>'></script>
    </body>
</html>