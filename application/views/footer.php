                    ...
                    <div class="widgets cols_4 clearfix">
                        ...
                        <aside id="contacts-2" class="widget widget_contacts">
                            ...
                            <ul class="style_2">
                                ...
                                <li class="page_item page-item-2 current_page_item">
                                    <a href="<?php echo site_url() . 'politica-privacidad'; ?>"><span class="h6">Política De Privacidad</span></a>
                                </li>
                                <li class="page_item page-item-2 current_page_item">
                                    <a href="<?php echo site_url() . 'politica-privacidad'; ?>"><span class="h6">Política De Cookies</span></a>
                                </li>
                            </ul>
                        </aside>
                        <aside id="contacts-2" class="widget widget_contacts">
