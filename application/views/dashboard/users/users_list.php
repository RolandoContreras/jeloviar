                                                        ...
                                                        <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0" rowspan="1" colspan="1">Privilegio</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($value->privilage == 1) {
                                                                        $valor = "Control Simple";
                                                                    } else {
                                                                        $valor = "Control Total";
                                                                    }
                                                                    ?>
                                                                    <span class="badge badge-pill badge-info" style="font-size: 90%;"><?php echo $valor; ?></span>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <span class="badge badge-pill <?php echo $stilo ?>" style="font-size: 90%;"><?php echo $valor; ?></span></td>
                                                                </td>
                                                                <td>
                                                                    <div class="operation">
                                                                        <div class="btn-group">
