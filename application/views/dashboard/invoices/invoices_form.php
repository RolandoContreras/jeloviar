                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" method="post" action="javascript:void(0);" onsubmit="validate_invoices();">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <?php if (isset($obj_invoices)) { ?>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Fecha</label>
                                                        <input class="form-control" type="text" id="date" name="date"  placeholder="YYYY/mm/dd" value="<?php echo isset($obj_invoices->date) ? formato_fecha($obj_invoices->date) : ""; ?>" class="input-xlarge-fluid" placeholder="Fecha" disabled="">
                                                    </div>
