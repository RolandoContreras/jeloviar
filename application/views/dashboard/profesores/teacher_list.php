            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Mantenimientos de Profesores</h5>
                </div>
                <ul class="breadcrumb">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <button class="btn btn-secondary" type="button" onclick="new_teacher();"><span><span class="pcoded-micon"><i data-feather="plus"></i></span> Nuevo</span></button>
                  </div>
                            ...
                            <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                              <thead>
                                <tr role="row">
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" style="width: 100px;"
                                    aria-label="Office: activate to sort column ascending">PROFECIÓN</th>
                                  <th class="sorting" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" style="width: 100px;"
                              ...
                              <tbody>
                                ...
                                <tr>
                                <th><?php echo $value->teacher_id;?></th>
                                <td><?php echo formato_fecha_barras($value->date);?></td>
                                <td><b><?php echo $value->name;?></b></td>
                                <td><span class="badge badge-pill badge-info" style="font-size: 100%;"><?php echo $value->profetion;?></span></td>
                                <td><img src="<?php echo site_url()."assets/cms/img/profesores/$value->img";?>" width="50"></td>
                                <td>
                                ...
                                <td>
                                    <div class="operation">
                                            <div class="btn-group">
                                               <button class="btn btn-secondary" type="button" onclick="edit_teacher('<?php echo $value->teacher_id;?>');"><span><span class="pcoded-micon"><i data-feather="edit"></i></span> Editar</span></button>
                                               <button class="btn btn-secondary" type="button" onclick="delete_teacher('<?php echo $value->teacher_id;?>');"><span><span class="pcoded-micon"><i data-feather="trash-2"></i></span> Eliminar</span></button>
                                            </div>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                              ...
                              <tfoot>
                                <tr>
                                  ...
                                  <th rowspan="1" colspan="1">PROFECION</th>
