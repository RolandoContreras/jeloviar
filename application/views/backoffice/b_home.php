                                        ...
                                        <div class="grid">
                                            <?php foreach ($obj_courses as $value) { ?>
                                                <figure class="effect-apollo">
                                                    <img src="<?php echo site_url() . "assets/cms/img/cursos/$value->img"; ?>" alt="advance-3">
                                                    <figcaption>
...
$(document).ready(function() {
    swal("Hasta un 80% de descuento", "Mira todos los cursos que tenemos para ti. Apúrate que el momento de aprender es ahora.", "success");
});
</script>
