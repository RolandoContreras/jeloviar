...
<html lang="en-US" class="no-js">
    ...
    <body class="page-template-default page page-id-2 logged-in stm_lms_button pmpro-body-has-access skin_custom_color online-light stm_preloader_1 wpb-js-composer js-comp-ver-5.6 vc_responsive"
        ...
        <link rel='stylesheet' id='stm-lms-courses-css' href='<?php echo site_url() . 'assets/backoffice/css/footer/courses.css?ver=81'; ?>' type='text/css' media='all' />
        <link rel='stylesheet' id='stm-lms-courses_filter-css' href='<?php echo site_url() . 'assets/backoffice/css/footer/courses_filter.css?ver=81'; ?>' type='text/css' media='all' />
        ...
        <script src='<?php echo site_url() . 'assets/backoffice/js/courses_filters.js?ver=81'; ?>'></script>
        <script src='<?php echo site_url() . 'assets/backoffice/js/courses_filter.js?ver=81'; ?>'></script>
