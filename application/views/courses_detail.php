                                                            ...
                                                            <div id=thim-landing-course-menu-tab>
                                                                <div class="container wrapper clearfix">
                                                                    ...
                                                                    <div class="course-purchase-info has-wishlist">
                                                                        <span class=course-origin-price> €<?php echo $obj_courses->price_del;?></span><span class=course-price>€<?php echo $obj_courses->price;?></span>
                                                                        <div class="learn-press-course-buttons lp-course-buttons">
                                                                            <form name=purchase-course class="purchase-course guest_checkout" enctype="multipart/form-data">
                                                                                <button onclick="add_cart_home('<?php echo $obj_courses->course_id;?>','<?php echo $obj_courses->price;?>','<?php echo $obj_courses->name;?>');" class="button"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp; Comprar el Curso </button>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="inner-course ">
                                                                            <div class=wrapper-course-thumbnail>
                                                                                ...
                                                                                <div class="course-price">
                                                                                    <span class="course-origin-price">€<?php echo $value->price_del;?></span>
