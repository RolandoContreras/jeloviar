                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="vc_custom_heading vc_custom_1532608711151">
                                                    <h3 style="text-align: left;margin-top: 0px;"><?php echo $obj_textos->titulo_mensaje; ?></h3>
                                                </div>
                                    ...
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1435139343164">
                                            <div class="stm_sm_gutter_back wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div class="icon_box stm_icon_box_hover_h3 dark module__0c0a3d70baf224e2ccbfc8d4a1bda10d clearfix">
                                            ...
                                            <div class="stm_sm_gutter_back wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div class="icon_box stm_icon_box_hover_h3 dark module__0c0a3d70baf224e2ccbfc8d4a1bda10d clearfix">
                                                            <div class="icon_alignment_left">
                                                                <div class="icon vc_custom_1435665617761"> <i class="fa-icon-stm_icon_mail-o"></i></div>
                                                                <div class="icon_text">
                                                                    <h5 style="color:#555555"> Web:</h5>
                                                                    <p>
                                                                        <?php echo $obj_textos->web; ?>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
