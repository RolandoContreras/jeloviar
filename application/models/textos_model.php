...
class textos_model_atributos{	
    ...
    var $boton_cursos='';
    var $titulo_boletin='';
    var $description_boletin='';
    var $boton_boletin='';
    var $nosotros_footer='';
    var $text_nosotros_footer='';
    var $titulo_contacto_footer='';
    var $email_footer='';
    var $phone_footer='';
    var $address_footer='';
}
...
class Textos_Model extends CI_Model{ 
    ...
    public function __construct() {
        parent::__construct();  
        $this->table = 'textos';
	$this->table_id = 'texto_id';
        $this->texto_id='';
        $this->titulo_home='';
        $this->description_home='';
        $this->boton_home='';
        $this->titulo_cursos='';
        $this->boton_cursos='';
        $this->titulo_boletin='';
        $this->description_boletin='';
        $this->boton_cursos='';
        $this->titulo_boletin='';
        $this->description_boletin='';
        $this->boton_boletin='';
        $this->nosotros_footer='';
        $this->text_nosotros_footer='';
        $this->titulo_contacto_footer='';
        $this->email_footer='';
        $this->phone_footer='';
        $this->address_footer='';
	$this->fields = new textos_model_atributos();
    }   
